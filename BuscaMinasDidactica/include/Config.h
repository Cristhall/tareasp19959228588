...
class Config
{
    ...
    public:
        Config(int filasTablero, int columnasTablero, int minasTablero, bool modoDesarrolladorTablero, int vidasTablero); // Se utiliza para inicializar los Atributos de un objeto de la clase.
        ...
        int getvidasTablero(); // Es una función que devuelve el valor del atibuto setvidasTablero.
        int setvidasTablero(int vidasTablero); //es una función  que establece el valor del atributo setvidasTablero y devuelve el nuevo valor.
