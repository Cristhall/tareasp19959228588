...
void Calculos::verPago(string id, string nombre, int n)
{
    ...
    cout << "\t* cantidad horas extras - " << cHExtras << endl;
    cout << "\t* monto horas extras    - " << hExtras << endl;
	...
	file<<std::left<<std::setw(15)<< id <<std::left<<std::setw(15)<< nombre<<std::left<<std::setw(15)<< salario <<std::left<<std::setw(15)<< bono <<std::left<<std::setw(15)<< cHExtras <<std::left<<std::setw(15)<< hExtras<<std::left<<std::setw(15)<< igss <<std::left<<std::setw(15)<< irtra <<std::left<<std::setw(15)<< isr <<std::left<<std::setw(15)<< salariototal << "\n";
	file.close();
}
